...
likelihood <- function(data,theta) {
  ...
  E0 <- theta[6] # initial number of exposed individuals
...
prior <- function(theta){
  ...
  return(log_prior_beta + log_prior_delta + log_prior_gamma + log_prior_phi + log_prior_S0 +  
           log_prior_E0 + log_prior_I0)
}
...
Parameters <- c("Beta", "Delta", "Gamma", "Phi", "S0","E0", "I0")
...
write.table(ASMC_AMTM_ESS, file = "/scratch/theniw8/ASMC_AMTM_Finale_1000_0.99_ESS.csv", sep = "," ,row.names = FALSE)
write.table(ASMC_AMTM_alpha, file = "/scratch/theniw8/ASMC_AMTM_Finale_1000_0.99_alpha.csv", sep = "," ,row.names = FALSE)
write.table(ASMC_AMTM_W, file = "/scratch/theniw8/ASMC_AMTM_Finale_1000_0.99_W.csv", sep = "," ,row.names = FALSE)
write.table(ASMC_AMTM_logZ, file = "/scratch/theniw8/ASMC_AMTM_Finale_1000_0.99_logZ.csv", sep = "," ,row.names = FALSE)
write.table(ASMC_AMTM_rsp, file = "/scratch/theniw8/ASMC_AMTM_Finale_1000_0.99_rsp.csv", sep = "," )