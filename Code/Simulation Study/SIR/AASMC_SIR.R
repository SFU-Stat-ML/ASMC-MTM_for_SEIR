...
asmc <- function(K, theta_cov, tuning_param, init, data, likelihood, prior, reference){
  ...
  ## Initialize weights
  W[[r]] <- rep(1/K,K) # normalized weights
  logW <- log(W[[r]])
...
K <-5000 # number of particles
d <- 5 # number of parameters to be estimated
...
write.table(AASMC_ESS, file = "/scratch/theniw8/AASMC_SIR_1000_0.99_ESS.csv", sep = "," ,row.names = FALSE)
write.table(AASMC_alpha, file = "/scratch/theniw8/AASMC_SIR_1000_0.99_alpha.csv", sep = "," ,row.names = FALSE)
write.table(AASMC_W, file = "/scratch/theniw8/AASMC_SIR_1000_0.99_W.csv", sep = "," ,row.names = FALSE)
write.table(AASMC_logZ, file = "/scratch/theniw8/AASMC_SIR_1000_0.99_logZ.csv", sep = "," ,row.names = FALSE)
write.table(AASMC_rsp, file = "/scratch/theniw8/AASMC_SIR_1000_0.99_rsp.csv", sep = "," )
