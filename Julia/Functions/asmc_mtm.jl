...
# ASMC Function
function asmc(K, d, b, tuning_param, init, data, likelihood, prior, reference, J)
    ...
    while alpha[r] < 1
       ...
       # updated mtmmove function
       push!(particles, [
        mtmmove(p, data, likelihood, prior, alpha, r, d, b, weighted_cov, J)
